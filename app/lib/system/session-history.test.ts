    ...
    const entries = [
      {
        ...
        regionLoadPct: { CHEST: 62 },
        regionStress: { CHEST: 0.42 },
      ...
      },
      {
        ...
        regionLoadPct: { CHEST: 64 },
        regionStress: { CHEST: 0.44 },
      ...
      },
      {
        ...
        regionLoadPct: { CHEST: 66 },
        regionStress: { CHEST: 0.48 },
      ...
      },
      {
        ...
        regionLoadPct: { CHEST: 68 },
        regionStress: { CHEST: 0.52 },
    ...
    const entries = [
      {
        ...
        regionLoadPct: { ARMS: 64, CORE: 70, QUADS: 58 },
        regionStress: { ARMS: 0.38, CORE: 0.44, QUADS: 0.3 },
      ...
      },
      {
        ...
        regionLoadPct: { ARMS: 66, CORE: 71, QUADS: 60 },
        regionStress: { ARMS: 0.4, CORE: 0.45, QUADS: 0.32 },
